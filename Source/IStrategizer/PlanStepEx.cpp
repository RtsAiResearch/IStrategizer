...
//////////////////////////////////////////////////////////////////////////
void PlanStepEx::State(ExecutionStateType p_state, RtsGame& p_RtsGame, const WorldClock& p_clock)
{
...
//////////////////////////////////////////////////////////////////////////
void PlanStepEx::Update(RtsGame& p_RtsGame, const WorldClock& p_clock)
{
    if (_firstUpdate)
    {
        Reset(p_RtsGame, p_clock);
        _firstUpdate = false;
    }
