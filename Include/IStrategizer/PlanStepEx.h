...
namespace IStrategizer
{
    ...
    protected:
        ...
        virtual void State(ExecutionStateType p_state, RtsGame& p_RtsGame, const WorldClock& p_clock);
    ...
    public:
        ...
        virtual void HandleMessage(RtsGame& p_RtsGame, Message* p_msg, bool& p_consumed) {}
        virtual void InitializeConditions();
        virtual bool SuccessConditionsSatisfied(RtsGame& p_RtsGame) = 0;
        virtual void UpdateAux(RtsGame& p_RtsGame, const WorldClock& p_clock) = 0;
        virtual void Reset(RtsGame& p_RtsGame, const WorldClock& p_clock) = 0;
