...
namespace IStrategizer
{
	...
	class GraphNode : public Serialization::UserObject
	{
		OBJECT_SERIALIZABLE(GraphNode);

	public:
		///> alias=Edges(vector(GraphEdge(TAnnotation)*))
		typedef Serialization::SVector < GraphEdge<TAnnotation>* > Edges;
	private:
		///> type=Edges
		Edges	_outEdges;
		///> type=Edges
	...
	public:
		...
		{
			_outEdges = Edges(p_size, nullptr);
			_inEdges = Edges(p_size, nullptr);
